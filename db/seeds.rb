...
#Crear clientes
Client.create name: 'Damon', company_name: 'Google', document: '1234', email: 'damon@google.com', user: User.first
Client.create name: 'Khaterine', company_name: 'Google', document: 'abcd', email: 'khaterine@google.com', user: User.first
